...
const CustomExport = ({ t }) => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.warn('[CustomExport] Failed to preview audio track', err);
        stopPreview();
      }
    })();
  ...
  useEffect(() => {
    ...
    const handler = (evt, args = {}) => {
      ...
      console.log('[CustomExport] EXPORT_COMPLETED', args);
...
export default withTranslation()(CustomExport);
